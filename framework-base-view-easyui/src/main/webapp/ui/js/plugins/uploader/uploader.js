  ...
  Main.prototype = {
    ...
    upload : function(index) {
      ...
      if(Browser.ie!=9) {
        ...
        bStreaming && bFileSlice ? (self.uploadFile(file, uploadURL, "testId", "resumeUpload"))
          : self.uploadFile(file, frmUploadURL, "testId", "formUpload");
        /*
         ...
         bStreaming && bFileSlice ? (self.uploadInfo[index].serverAddress = server,self.uploadFile(file, uploadURL, token, "resumeUpload")) : self.uploadFile(file, frmUploadURL, token, "formUpload");
         } else {
         /!** not found any token *!/
